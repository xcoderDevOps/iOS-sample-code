...
public extension UIView {
    ...
    public func setConstraintConstant(_ constant: CGFloat, forAttribute attribute: NSLayoutConstraint.Attribute) -> Bool {
    ...
    public func constraintConstantforAttribute(_ attribute: NSLayoutConstraint.Attribute) -> CGFloat {
        let constraint: NSLayoutConstraint? = self.constraintForAttribute(attribute)
        if constraint != nil {
    ...
    public func hideView(_ hidden: Bool, byAttribute attribute: NSLayoutConstraint.Attribute) {
