...
- (void)localizeAlertStringsForCurrentAppStoreVersion:(NSString *)currentAppStoreVersion {
    ...
    if (_forceLanguageLocalization) {
        ...
        _theNewVersionMessage = [NSString stringWithFormat:[self forcedLocalizedStringForKey:@"A new version of %@ is available.\nPlease update to version %@ now."], _appName, currentAppStoreVersion];
        ...
        _theNewVersionMessage = [NSString stringWithFormat:[self localizedStringForKey:@"A new version of %@ is available.\nPlease update to version %@ now."], _appName, currentAppStoreVersion];
